class Centrifugo < Formula
  desc "Centrifugo"
  homepage "https://github.com/stone-payments/centrifugo"
  url "https://github.com/stone-payments/centrifugo/releases/download/v1.7.4/centrifugo-1.7.4-darwin-amd64.zip"
